...
package("freetype")
    ...
    --[[
    set_urls("https://github.com/freetype/freetype/archive/refs/tags/VER-$(version).tar.gz", {
        version = function (version) 
            return tostring(version):gsub('%.', '-')
        end
    })
    add_versions("2.13.2", "427201f5d5151670d05c1f5b45bef5dda1f2e7dd971ef54f0feaaa7ffd2ab90c")
    ]]
