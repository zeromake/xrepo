local function getVersion(version)
    local versions ={
        ...
        ["2025.08.17-alpha"] = "archive/2add78609ecba7e0ec062968e711110b3647b0e1.tar.gz",
        --insert getVersion
    }
...
package("sfparse")
    ...
    --insert version
    add_versions("2025.08.17-alpha", "eea4e501e3c4b50b8bd5daaac8b20adc8d54f576f9ad356584301916a850d018")
