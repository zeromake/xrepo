...
local function getVersion(version)
    local versions ={
        ...
        ["2.0.1-alpha"] = "archive/895b080a3c2189feaea0919af8982e9a248ff7d6.zip",
    }
...
package("vulkan_memory_allocator")
    ...
    add_versions("2.0.1-alpha", "238a4b3afd16c934bc4e4035dee982ff85e47d6a80a409378f81f0cccdf599e3")
