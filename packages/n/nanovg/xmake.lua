local function getVersion(version)
    local versions ={
        ...
        ["2025.10.27-alpha"] = "archive/0bd0c8f0be26875017a711f54181ed3ae6df1311.tar.gz",
        --insert getVersion
    }
...
package("nanovg")
    ...
    if os.exists(p) and os.isdir(p) then
        ...
        --insert version
    add_versions("2025.10.27-alpha", "556ff1f9db6d7fe8d5b374e8b3370fc04d5697715e6633a1714756a893a629a9")
