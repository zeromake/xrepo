...
target("curl")
    ...
    -- if not is_plat("windows", "mingw") then
        ...
        configvar_check_cfuncs("HAVE_GETPEERNAME", "getpeername", {includes={"windows.h", "winsock.h"}})
        configvar_check_cfuncs("HAVE_GETSOCKNAME", "getsockname", {includes={"windows.h", "winsock.h"}})
        configvar_check_cfuncs("HAVE_GETHOSTNAME", "gethostname", {includes={"windows.h", "winsock.h"}})
        configvar_check_cfuncs("HAVE_GETTIMEOFDAY", "gettimeofday", {includes={"sys/time.h"}})
        configvar_check_cfuncs("HAVE_FTRUNCATE", "ftruncate", {includes={"unistd.h"}})
        configvar_check_cfuncs("HAVE_CLOSESOCKET", "closesocket", {includes={"windows.h", "winsock.h"}})
