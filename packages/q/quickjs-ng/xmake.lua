local function getVersion(version)
    local versions ={
        ...
        ["2025.10.21-alpha"] = "archive/2f6cad81fdd2cff49bb689ef885453a5480f6196.tar.gz",
        --insert getVersion
    }
...
package("quickjs-ng")
    ...
    --insert version
    add_versions("2025.10.21-alpha", "79db1f7c4cfe364902a971a496748cb229707e04d744ce4489df3afb44330c96")
