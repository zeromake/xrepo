package("jpegturbo")
    ...
    on_install(function (package)
        ...
        transforme_configfile("jversion.h.in")
        transforme_configfile("jconfig.h.in")
        transforme_configfile("jconfigint.h.in")
        transforme_configfile("simd/arm/neon-compat.h.in")
        local configs = {}
