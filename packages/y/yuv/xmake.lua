local function getVersion(version)
    local versions ={
        ...
        ["2024.06.14-alpha"] = "archive/5adc2ce2cb15bf081ea7b37ce3e1484db88d3e94.tar.gz",
    }
...
package("yuv")
    ...
    add_versions("2024.06.14-alpha", "4509f9d5d3df25bc1b94f4275f4622f0352e4e1c10eda99c262fe322f9b1453a")
