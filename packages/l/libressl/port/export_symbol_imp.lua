...
function main(target, opt)
    ...
    local sym_file = nil
    if opt == nil then
        sym_list = target:extraconf("rules", "export_symbol", "export") or {}
        unsym_list = target:extraconf("rules", "export_symbol", "unexport") or {}
        sym_file = target:extraconf("rules", "export_symbol", "file")
    else
