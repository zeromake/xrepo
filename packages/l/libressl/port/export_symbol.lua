rule('export_symbol')
    on_config(function (target)
        ...
        local sym_list = target:extraconf("rules", "export_symbol", "export") or {}
        local unsym_list = target:extraconf("rules", "export_symbol", "unexport") or {}
        local sym_file = target:extraconf("rules", "export_symbol", "file")
        local syms = {}
        if sym_file then
